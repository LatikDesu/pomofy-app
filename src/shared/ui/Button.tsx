		...
		variants: {
			intent: {
				default: [
					...
					'hover:enabled:bg-[var(--color-default-hover)]',
					'disabled:bg-[var(--color-default-disabled)]',
					...
					'active:bg-[var(--color-default-active)]',
				...
				secondary: [
					...
					'hover:enabled:bg-[var(--color-secondary-hover)]',
				...
				danger: [
					'bg-[var(--color-danger)]',
					'text-[var(--text-default)]',
					'hover:enabled:bg-[var(--color-danger-hover)]',
					'disabled:bg-[var(--color-danger-disabled)]',
